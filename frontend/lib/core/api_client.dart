...
Future<bool> _tryRefresh(Dio dio, FlutterSecureStorage storage) async {
  ...
  try {
    ...
    await storage.write(key: 'access_token', value: resp.data['access_token'] as String);
    await storage.write(key: 'refresh_token', value: resp.data['refresh_token'] as String);
    return true;
  } catch (_) {
